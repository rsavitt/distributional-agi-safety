...
scores $p = P(v = +1)$. Across 11 scenarios (209 total epochs, 81
agent-slots), we find that ecosystem outcomes cluster into three regimes:
\emph{cooperative} (acceptance $> 0.93$, toxicity $< 0.30$),
\emph{contested} (acceptance $0.42$--$0.94$, toxicity $0.33$--$0.37$), and
\emph{adversarial collapse} (acceptance $< 0.56$, collapse by epoch 12--14).
Collapse occurred exclusively when adversarial fraction reached 50\%, and
governance tuning delayed but did not prevent it---shifting collapse from
